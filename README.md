...
- [100 Devs Homework Checklist](https://docs.google.com/document/d/177Ls9QS5ryjPBi82cjDnbtse5Of0RFl8/edit): A Google Docs verison. No links to materials. As of Sept 12, completely up-to-date and includes time-sensitive Huntober deadlines.
...
Most homework does not have provided solutions. If you build someting and it looks/works the way you want it to, you did it right. If you can't figure out how to get something to work, ask for help!  

## I already know XX. Should I start from Class 1? Can I get verified if I don't do all the classes?

There is value in starting from the beginning, even if you have some experience already, but it's not necessary. The choice is yours. You can still get verification if you don't do the early homework; Leon annouced a clean slate in class 32, so anything you missed before that will be forgiven.
...
If you are only looking for job hunting/freelancing advice, you can skip most of the classes, but you will not be able to get verification. Classes relevant to job hunting:

- [9: Networking Nght](https://youtu.be/OaglXfjsBaE)
- [15: How to Start Freelancing](https://youtu.be/OaglXfjsBaE)
- [25: Fix Your Resume](https://youtu.be/ZlB4BockYNQ)
- [33: Secrets to Landing Your First Tech Job](https://youtu.be/lIE1LFz4LJM)
- [34: Crush Your Technical Interviews](https://youtu.be/lIE1LFz4LJM)

These are the dedicated classes, but not only ones that cover job-related topics. For other mentions, you can check the [searchable subtitles](https://leonstreamscripts.herokuapp.com).
...
- Classes 42 & 43: Welcome Back classes after a long break (no teaching content)
...
Rufio also has a video on her [codewars workflow](https://www.youtube.com/watch?v=HazQz4qosR4).

## I have old katas I didn't upload to Github. How do I backdate git commits?

Rufio has two videos you can check out, one on her [entire codwars workflow](https://www.youtube.com/watch?v=HazQz4qosR4) and one on [how to backdate commits](https://www.youtube.com/watch?v=uFRY6Gxw9EA).
